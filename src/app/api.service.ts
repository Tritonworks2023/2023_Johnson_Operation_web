...
export class ApiService {
  ...
  //////////////
    ...
    fetch_data_admin(data) {
      return this.http.post(this.apiUrl + 'data_store_management/fetch_data_admin', data);
    }


    fetch_data_admin_form2(data) {
      return this.http.post(this.apiUrl + 'data_store_management/fetch_data_admin_form2', data);
    }
    ...
    fetch_userdetail(data) {
      return this.http.post(this.apiUrl + 'user_management/getlist_fetch_id',data);
    }
...
audit_userdetail_delete(data) {
  return this.http.post(this.apiUrl + 'audit_user_management/admin_delete', data);
}
audit_userdetail_filter_date(data) {
  return this.http.post(this.apiUrl + 'audit_user_management/filter_date', data);
}


audit_userdetail_login(data) {
  return this.http.post(this.apiUrl + 'audit_user_management/mobile/login_page', data);
}
...
fetch_area_breakdown(data){
  return this.http.post(this.apiUrl + 'service_userdetails/fetch_area_breakdown', data);
}
...
error_log_with_job_no(data) {
  return this.http.post(this.apiUrl + 'activity/check_error_log_job_no', data);
}
